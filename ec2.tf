...
resource aws_security_group my_security_group {
    ...
    vpc_id = aws_default_vpc.default.id  # (Interpolation) - Is a way in which you can inherit or extract values from terraform block

    # inbond rules for port 22
    ingress {
    from_port   = 22
    to_port     = 22
    protocol    = "tcp"
